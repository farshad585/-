  ...
  return (
    <>
      <SEO 
        ...
        description="شرایط استفاده از بسته‌ها و کتاب‌های صوتی و چاپی آکادمی چهل دروازه، ضوابط خرید آنلاین، مرجوعی کتب فیزیکی و اصول صیانت از اطلاعات هنرجویان."
      />
      ...
      <section className="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 border-b border-indigo-100 py-16 text-center max-w-7xl mx-auto rounded-b-3xl mb-12 shadow-xs">
        <div className="max-w-xl mx-auto px-4 space-y-3">
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            لطفاً پیش از تهیه دوره‌ها و یا کتب نفیس، آیین‌نامه انضباطی و حقوقی آکادمی چهل دروازه را مطالعه فرمایید.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 pb-20 space-y-12 text-right">
        ...
        <div className="space-y-4 bg-white p-6 md:p-8 rounded-3xl border border-indigo-100 shadow-xs">
          ...
          <p className="text-xs text-slate-600 leading-relaxed text-justify">
            کلیه کتب چاپی، کتاب‌های الکترونیکی PDF، دوره‌های آموزشی ویدیویی و فایل‌های صوتی فرکانسی ارائه شده در وب‌سایت چهل دروازه (40gates.ir) تحت حمایت مستقیم قانون حمایت از حقوق مؤلفان و مصنفان جمهوری اسلامی ایران است. تکثیر، توزیع، فروش مجدد یا اشتراک‌گذاری عمومی این فایل‌ها در سایر وب‌سایت‌ها، کانال‌های تلگرامی و گروه‌ها بدون اجازه کتبی مربی ارشد و مدیریت آکادمی، شرعاً و قانوناً ممنوع بوده و متخلفان تحت پیگرد حقوقی قرار خواهند گرفت.
          </p>
        </div>
