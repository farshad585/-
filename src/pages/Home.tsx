        ...
        <div className="hidden md:block relative z-10">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center px-4 space-y-7 my-4">
            ...
            >
              ...
              حقیقت اینه که ما هر شب رویا میبینیم؛ چه دلمون بخواد، چه نخواد... پس چه بهتر که به جای سرگردان بودن در خوابهای خستهکننده، آستین همت رو بالا بزنیم و از دنیای رویاهامون یه بهشت شخصی بسازیم! 💖
            </motion.p>
        ...
        <div className="block md:hidden relative z-10 space-y-4">
          ...
          >
            ...
            <p className="text-xs text-slate-700 leading-relaxed space-y-1 font-medium">
              <span className="block">حقیقت اینه که ما هر شب رویا میبینیم؛</span>
              <span className="block">چه دلمون بخواد، چه نخواد...</span>
              <span className="block">پس چه بهتر که به جای سرگردان بودن در خوابهای خستهکننده، آستین همت رو بالا بزنیم و از دنیای رویاهامون یه بهشت شخصی بسازیم! 💖</span>
            </p>
          </motion.div>
