      ...
      <div className="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
        ...
        <div className="space-y-6">
          ...
          <p className="text-xs leading-relaxed text-slate-600 font-light text-justify">
            شما هر شب به دنیای شخصی خودتان قدم می‌گذارید و از این حق انتخاب برخوردار هستید که به شکل آدمی معمولی یا در قامت پادشاهی بی‌همتا ظاهر شوید. آری؛ انتخاب با خود شماست. البته به این شرط که صاحب گوهر خودآگاهی باشید.
          </p>
          <div className="flex items-center gap-3">
            <a 
