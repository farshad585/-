...
export const PRODUCTS: Product[] = [
  ...
  // 11. کتاب آفریدگار رویاها
  {
    ...
    description: 'ثمره‌ی سال‌ها تجربه و آموزش و پژوهش بر موضوع برنامه‌ریزی ذهن و رویابینی آگاهانه. حاوی بهترین و مؤثرترین روش‌های غلبه بر کابوس‌ها و کنترل دنیای بی‌انتهای رویاها.\n\nاین کتاب دارای ۲ کیفیت چاپ می‌باشد (هر دو با ۱۰٪ تخفیف):\n۱. معمولی: ۳۹۹,۰۰۰ تومان (تخفیف ۱۰٪ -> ۳۵۹,۱۰۰ تومان)\n۲. تمام رنگی: ۴۹۹,۰۰۰ تومان (تخفیف ۱۰٪ -> ۴۴۹,۱۰۰ تومان)',
    shortDescription: 'دستورالعمل‌های ویژه برنامه‌ریزی و کنترل ابرکامپیوتر بیولوژیک ذهن در دو کیفیت چاپ (با ۱۰٪ تخفیف).',
    price: 399000,
    salePrice: 359100,
    type: 'printed',
    category: 'books',
  ...
  // 16. کتاب pdf چهل دروازه به ماورا - جلد1
  {
    id: '45360',
